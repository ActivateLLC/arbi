            ...
            >
              <div className="flex items-center gap-4 flex-1">
                ...
                {product.productImages && product.productImages.length > 0 ? (
                  <img
                    src={product.productImages.filter(img => img.includes('cloudinary.com'))[0] || product.productImages[0]}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-slate-400">
                    ${parseFloat(String(product.marketplacePrice || 0)).toLocaleString()} • {product.productImages?.filter(img => img.includes('cloudinary.com')).length || 0} images
                  </div>
                </div>
              </div>
              ...
              <div className="text-right">
                <div className="text-lg font-bold text-emerald-400">
                  ${parseFloat(String(product.estimatedProfit || 0)).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                </div>
