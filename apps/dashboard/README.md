...
Beautiful, responsive dashboard for the ARBI Autonomous Arbitrage System.

## Features

- **Real-time Opportunities Feed** - Live display of arbitrage opportunities with auto-refresh
- **Interactive Charts** - Profit analytics, score distribution, ROI trends
- **System Control Panel** - Start/stop autonomous scanning, configure thresholds
- **UHNW Luxury Tracker** - High-value opportunities ($10K+ profit)
- **Mobile Responsive** - Works perfectly on all devices
- **Dark Mode** - Built-in dark mode support

## Tech Stack

This dashboard is built using the following stack:
