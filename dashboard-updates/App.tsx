...
const App: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'simulation' | 'marketplace'>('marketplace');
        ...
        {activeTab === 'marketplace' ? (
          <>
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-400">Real-time data from api.arbi.creai.dev</p>
            </div>
